...
urlpatterns = [
    ...
    path(
        "teams/invite/<int:team_id>/<int:user_id>/<str:role>",
        views.team_invite,
        name="team_invite",
    ),
    path("teams/join", views.join_team, name="join_team"),
    path(
        "teams/join/<int:id>/<str:role>", views.joining_team_process, name="join_team_2"
    ),
    path(
        "teams/join/apply/<int:id>/<str:response>",
        views.joining_team_request,
        name="joining_team_request",
    ),
    ...
    path(
        "teams/calendar/<int:id>/<str:month>/<int:year>",
        views.team_calendar,
        name="calendar",
    ),
    path(
        "teams/settings/<int:id>/<int:user_id>",
        views.edit_team_member_absence,
        name="edit_team_member_absence",
    ),
    path(
        "teams/settings/promote/<int:id>/<int:user_id>",
        views.promote_team_member,
        name="promote_team_member",
    ),
    path(
        "teams/settings/demote/<int:id>/<int:user_id>",
        views.demote_team_member,
        name="demote_team_member",
    ),
    path(
        "teams/settings/remove/<int:id>/<int:user_id>",
    ...
    path(
        "absence/delete/<int:absence_id>/<int:user_id>/",
        views.absence_delete,
        name="Absence Delete",
    ),
    path(
        "absence/delete/<int:absence_id>/<int:user_id>/<int:team_id>/",
        views.absence_delete,
        name="Absence Delete",
    ),
    path(
        "absence_recurring/delete/<int:absence_id>/<int:user_id>/",
        views.absence_recurring_delete,
        name="Recurring Absence Delete",
    ),
    path(
        "absence_recurring/delete/<int:absence_id>/<int:user_id>/<int:team_id>/",
        views.absence_recurring_delete,
        name="Recurring Absence Delete",
    ),
    path("absence/edit/<int:pk>", views.EditAbsence.as_view(), name="absence_edit"),
    path(
        "absence/edit_recurring/<int:pk>",
        views.edit_recurring_absences,
        name="recurring_absence_edit",
    ),
