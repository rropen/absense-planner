...
urlpatterns = [
    ...
    path("calendar/0/", all_calendar, name="all_Calendar"),
    path("calendar/0/<str:month>/<int:year>", all_calendar, name="all_calendar"),
    ...
    path("teams/calendar/<int:id>", team_calendar, name="Calendar"),
    path("teams/calendar/<int:id>/<str:month>/<int:year>", team_calendar, name="calendar"),
    ...
    path("calendar/set_month", set_calendar_month, name="set_month"),
    path("calendar/1/", api_calendar_view, name="api_calendar"),
    path("calendar/1/<str:month>/<int:year>", api_calendar_view, name="api_calendar")
]
