...
urlpatterns = [
    ...
    path(
        "teams/api-calendar/<int:id>",
        calendarview.api_team_calendar,
        name="api_team_calendar",
    ),
    path(
        "teams/api-calendar/<int:id>/<str:month>/<int:year>",
        calendarview.api_team_calendar,
        name="api_team_calendar",
    ),
    ...
    path(
        ...
        absences.absence_recurring_delete,
        name="recurring_absence_delete",
    ),
    path(
    ...
    path(
        ...
        absences.edit_recurring_absences,
    ...
    path(
        "main_calendar/<str:month>/<int:year>",
        views.main_calendar,
        name="main_calendar",
    ),
    path(
        "remove_lingering_perms",
        views.remove_lingering_perms,
        name="remove_lingering_perms",
    ),
    path(
        "jsi18n",
    ...
    ),  # This lets Django find the CSS files when debug is set to false
]
