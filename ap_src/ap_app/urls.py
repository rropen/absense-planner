...
urlpatterns = [
    ...
    path("absence/delete/<int:absence_id>/<int:team_id>/<int:user_id>", views.absence_delete, name="Absence Delete"),
    path("absence_recurring/delete/<int:absence_id>/<int:team_id>/<int:user_id>", views.absence_recurring_delete, name="Recurring Absence Delete"),
