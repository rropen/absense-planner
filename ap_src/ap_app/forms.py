...
class CreateTeamForm(forms.ModelForm):
    class Meta:
        model = Team
        fields = ["name", "ignore_name_similarity", "description", "private"]
    ...
    private         = forms.BooleanField(label='Private Team', required=False, widget=forms.CheckboxInput(attrs={"class":""}))
    ignore_name_similarity = forms.BooleanField(label='Ignore Name Similarity - If unchecked, the team name must be unique',
