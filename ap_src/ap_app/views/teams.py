...
def teams_dashboard(request) -> render:
    ...
    api_specific_method = request.POST.get(
        "method"
    )  # Using .get will not raise an error
    if api_specific_method == "favourite":
        try:
            ...
            debug = (
                "Error: Team ID was not found in request so it cannot be favourited."
            )
            ...
            debug = (
                "Error: Cannot obtain Team ID from request for favouriting. Exception: "
                + str(exception)
            )
            print_messages(request, error=error, debug=debug)
        else:
            try:
                ...
                error = "Error in favouriting team - " + derive_http_error_message(
                    exception
                )
            except ConnectionError as exception:
                error = "Error - could not favourite the team you requested due to a connection error."
                debug = (
                    "Error: Could not connect to the API to favourite a team. Exception: "
                    + str(exception)
                )
            except RequestException as exception:
                error = "Error - could not favourite the team you requested due to an unknown error."
                debug = (
                    "Error: Could not send a request to the API to favourite a team. Exception: "
                    + str(exception)
                )
            else:
...
def leave_team(request):
    ...
    try:
        ...
        return redirect(
            reverse("dashboard")
        )  # Return early because there is no Team ID to use
    except Exception as exception:
        error = (
            "Error - could not obtain the team you requested due to an unknown error"
        ...
        debug = (
            "Error: Cannot obtain Team ID from request for leaving. Exception: "
            + str(exception)
        )
        print_messages(request, error=error, debug=debug)
    ...
    try:
        ...
        error = (
            "Error - could not leave the team you requested due to a connection error."
        )
        debug = (
            "Error: Could not connect to the API to leave a team. Exception: "
            + str(exception)
        )
    except RequestException as exception:
        error = (
            "Error - could not leave the team you requested due to an unknown error."
        )
        debug = (
            "Error: Could not send a request to the API to leave a team. Exception: "
            + str(exception)
        )
    else:
        ...
        print_messages(
            request, success=success, error=error, debug=debug, warning=warning
        )
...
def create_team(request: HttpRequest) -> render:
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            data = (
                request.POST
            )  # This is the data sent by the user in the CreateTeamForm
            headers = {"Authorization": TEAM_APP_API_KEY, "User-Token": user_token}
            ...
            try:
                ...
                error = "Error in creating a team - " + derive_http_error_message(
                    exception
                )
                ...
                debug = (
                    "Error: Could not connect to the API to create a team. Exception: "
                    + str(exception)
                )
            except RequestException as exception:
                error = "Error - could not create the team due to an unknown error."
                debug = (
                    "Error: Could not send a request to the API to create a team. Exception: "
                    + str(exception)
                )
            finally:
                print_messages(request, success=success, error=error, debug=debug)
...
def join_team(request) -> render:
    ...
    if request.method == "POST":
        ...
        try:
            ...
            warning = (
                "Warning - could not obtain the team you requested due to an unknown error"
                "so it could not be left."
            )
            debug = (
                "Warning: Cannot obtain Team ID from request for leaving. Exception: "
                + str(exception)
            )
            print_messages(request, warning=warning, debug=debug)
        else:
            ...
            if method == "join":
                try:
                    ...
                    debug = (
                        "Error: Cannot obtain Team ID from request for joining. Exception: "
                        + str(exception)
                    )
                    print_messages(request, error=error, debug=debug)
                ...
                try:
                    ...
                    error = "Error in joining the team - " + derive_http_error_message(
                        exception
                    )
                except ConnectionError as exception:
                    error = "Error - could not join the team due to a connection error."
                    debug = (
                        "Error: Could not connect to the API for a user to join a team. Exception: "
                        + str(exception)
                    )
                except RequestException as exception:
                    error = "Error - could not join the team due to an unknown error."
                    debug = (
                        "Error: Could not send a request to the API for a user to join a team. Exception: "
                        + str(exception)
                    )
                else:
    ...
    try:
        api_response = session.get(
            url=url, headers=headers, timeout=TEAM_APP_API_TIMEOUT
        )
        api_response.raise_for_status()
    except HTTPError as exception:
        error = (
            "Error in fetching teams that are available to join - "
        ...
        debug = (
            "Error: Could not connect to the API to fetch a user's teams that they are not in. Exception: "
            + str(exception)
        )
    except RequestException as exception:
        error = "Error - could not fetch teams that are available to join due to an unknown error."
        debug = (
            "Error: Could not send a request to the API to fetch a user's teams that they are not in. Exception: "
            + str(exception)
        )
    else:
...
def edit_team(request: HttpRequest, id):
    ...
    try:
        ...
        debug = (
            "Error: Could not connect to the API to fetch a user's joined teams so could not validate a team for editing. Exception: "
            + str(exception)
        )
    except RequestException as exception:
        ...
        debug = (
            "Error: Could not send a request to the API to fetch a user's joined teams so could not validate a team for editing.  Exception: "
            + str(exception)
        )
    finally:
        if error:
    ...
    if id not in team_ids:
        ...
        debug = (
            "Error: Team ID not among the Team IDs listed in user's joined teams. User's joined teams: "
            + str(users_teams)
        )
    ...
    try:
        ...
        warning = (
            "Warning - Error in fetching information about that team - "
            + derive_http_error_message(exception)
        )
    except ConnectionError as exception:
        warning = "Warning - could not fetch information about that team due to a connection error."
        debug = (
            "Error: Could not connect to the API to fetch the data about a specific team so could not display them during team editing. Exception: "
            + str(exception)
        )
    except RequestException as exception:
        warning = "Warning - could not fetch information about that team due to an unknown error."
        debug = (
            "Error: Could not send a request to the API to fetch the data about a specific team so could not display them during team editing. Exception: "
            + str(exception)
        )
    finally:
        print_messages(request, warning=warning, debug=debug)
    ...
    if not warning:
        team = api_data[0]
        initial_data = {"name": team["name"], "description": team["description"]}
        form = CreateTeamForm(
            initial=initial_data
        )  # Reuse the form used for creating a team

        current_user = request.user.username

        is_owner = any(
            member["user"]["username"] == current_user
            and member["user"].get("role_info", {}).get("role", "").lower() == "owner"
        ...
        initial_data = {"name": None, "description": None}
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            try:
                ...
                error = (
                    "Warning - Error in editing the team - "
                    + derive_http_error_message(exception)
                )
            except ConnectionError as exception:
                error = "Warning - could not edit the team due to a connection error."
                debug = (
                    "Error: Could not connect to the API to edit a team. Exception: "
                    + str(exception)
                )
            except RequestException as exception:
                error = "Warning - could not edit the team due to an unknown error."
                debug = (
                    "Error: Could not send a request to the API to edit a team. Exception: "
                    + str(exception)
                )
            else:
            ...
            try:
                ...
                warning = (
                    "Warning - Error in fetching members of that team - "
                    + derive_http_error_message(exception)
                )
            except ConnectionError as exception:
                warning = "Warning - could not fetch the members of that team due to a connection error."
                debug = (
                    "Error: Could not connect to the API to fetch the members of a specific team so could not display them during team editing. Exception: "
                    + str(exception)
                )
            except RequestException as exception:
                warning = "Warning - could not fetch the members of that team due to an unknown error."
                debug = (
                    "Error: Could not send a request to the API to fetch the members of a specific team so could not display them during team editing. Exception: "
                    + str(exception)
                )
            finally:
                print_messages(request, warning=warning, debug=debug)
    ...
    return render(
        request, "teams/edit_team.html", {"team": team, "roles": roles, "form": form}
    )
...
def delete_team(request: HttpRequest):
    ...
    try:
        ...
        debug = (
            "Error: Cannot obtain Team ID from request for deleting. Exception: "
            + str(exception)
        )
        print_messages(request, error=error, debug=debug)
    ...
    try:
        ...
        error = "Warning - Error in deleting the team - " + derive_http_error_message(
            exception
        )
    except ConnectionError as exception:
        error = "Warning - could not delete the team due to a connection error."
        debug = (
            "Error: Could not connect to the API to delete a team. Exception: "
            + str(exception)
        )
    except RequestException as exception:
        error = "Warning - could not delete the team due to an unknown error."
        debug = (
            "Error: Could not send a request to the API to delete a team. Exception: "
            + str(exception)
        )
    else:
        ...
        try:
            check_for_lingering_switch_perms(
                request.user.username, remove_switch_permissions, user_token
            )
        except Exception as exception:
            warning = "Warning - could not remove unnecessary switch permissions."
            debug = warning + " Exception: " + str(exception)
        ...
        print_messages(
            request, error=error, debug=debug, success=success, warning=warning
        )
        if error:
